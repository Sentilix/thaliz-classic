...
L["Default Messages"] = {
	-- UBRS
	{ "(Ressing) THIS CANNOT BE!!! %s, deal with these insects."         },	-- Rend Blackhand (UBRS)
	-- ZG
	{ "(Ressing) I\'m keeping my eye on you, %s!"                        },	-- Bloodlord Mandokir (Raptor boss)
	{ "(Ressing) %s, fill me with your RAGE!"                            },	-- High Priest Thekal (Tiger boss)
	...
	{ "(Ressing) You have failed me, %s! Justice is met, indeed!"        }, 	-- Ragnaros
	-- BWL
	{ "(Ressing) Forgive me %s, your death only adds to my failure."     },	-- Vaelastrasz
	-- AQ40
	{ "(Ressing) Let your death serve as an example, %s!"                },	-- Prophet Skeram
	{ "(Ressing) Only flesh and bone. %cs are such easy prey, %s!"       },	-- Emperor Vek'lor (Twins)
	...
	{ "(Ressing) The first res goes to %s! Anyone care to wager?"        },	-- Lady Blaumeux (4HM)
